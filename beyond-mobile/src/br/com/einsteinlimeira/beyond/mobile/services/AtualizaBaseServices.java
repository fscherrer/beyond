    ...
    try {
      ...
      if (statusCode != 200) {
        ...
        CacheExterno cacheExterno = new Gson().fromJson(json, CacheExterno.class);
         ...
         // O approach tomado Ã©, por ora, remover todos os dados atualmente na base e 
         // inserir tudo novamente.
        
        CidadeServices cidadeServices = new CidadeServices();
        // remove as cidades jÃ¡ na base
        ...
        Log.i(Constantes.TAG, "AtualizaÃ§Ã£o da base de dados local realizada com sucesso");
